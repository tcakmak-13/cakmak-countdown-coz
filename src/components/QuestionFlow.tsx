  ...
  if (selectedQuestion) {
    ...
    return (
      <ThreadView
        ...
        setAnswerImagePreview={setAnswerImagePreview}
        sendingAnswer={sendingAnswer}
        showAnswerImagePicker={showAnswerImagePicker}
        setShowAnswerImagePicker={setShowAnswerImagePicker}
        onBack={() => { setSelectedQuestion(null); setAnswers([]); }}
        onSubmitAnswer={handleSubmitAnswer}
        onMarkBest={markBestAnswer}
        onUnmarkBest={unmarkBestAnswer}
        onDeleteTarget={setDeleteTarget}
        onAskAI={askAI}
        openCanvas={openCanvas}
        lightboxSrc={lightboxSrc}
        lightboxQuestionId={lightboxQuestionId}
        onCloseLightbox={() => { setLightboxSrc(null); setLightboxQuestionId(null); }}
        onCanvasShare={handleCanvasShareAsAnswer}
